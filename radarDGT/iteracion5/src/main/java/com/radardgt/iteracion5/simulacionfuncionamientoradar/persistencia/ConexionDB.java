 ...
 */
package com.radardgt.iteracion5.simulacionfuncionamientoradar.persistencia;
...
* Author/s name: LUIS
* Class version: 1.0.0
* Class description: Clase Agente
**********************************************************************
*/
public class ConexionDB {
     ...
     * @param SID En oracle ORADAM2 y en MySQL la base de datos usada (en el resto vacio)
     */
    public ConexionDB(String SGBD, String PC, String SID, String usuario, String password ){
        try {
            switch(SGBD){
                case "MySQL":
                    Class.forName("com.mysql.jdbc.Driver");
                    conexion = DriverManager.getConnection("jdbc:mysql://"+PC+"/"+SID,usuario,password);
                    break;
                case "Oracle":
                     Class.forName("oracle.jdbc.driver.OracleDriver");
                    conexion = DriverManager.getConnection("jdbc:oracle:thin:@"+PC+":1521:"+SID,usuario,password);
                    break;
     ...
     * Recomendable para valores únicos de String
     ...
     * @return Indica si existe o no el valor
     */
    public boolean existeValor(int valor, String columna, String tabla){
    ...
    /**
     * Indica si el resultado devuelve uno o mas registros
     * La consulta debe ser un count
     * @param query Consulta que queremos comprobar que tiene mas o igual de un registro
    ...
    /**
     * Indica el ultimo ID de la base de datos
    ...
    /**
     * Devuelve el proximo ID sobre el que podemos usar
    ...
    /**
     * Devuelve el ultimo id que no esta eliminado (si se usa una columna eliminado)
     * @param columnaEliminado Nombre de la columna usada para indicar si esta eliminado o no un registro de la base de datos
     * @param columnaID Nombre de la columna de la base de datos
     * @param tabla Nombre de la tabla de la base de datos
    ...
    /**
     * Devuelve el registro menor de una columna
     ...
     * @param columnaNoVisible Nombre de la columna que no se verá en el comboBOx (ID por ejemplo)
     * @param columnaVisible Nombre de la columna que será visible en el comboBox
     */
     ...
     * Se adapta automaticamente al número de columnas
     * Se debe ejecutar el metodo "ejecutarConsulta" antes de llamar a este método
    ...
    /**
     * Permite crear una consulta preparada, pasando los datos
     * @param datos Array de objetos con los datos
     * @param intruccionPreparada Consulta preparada
    ...
    private String[] tiposDatos(Object[] datos) {
